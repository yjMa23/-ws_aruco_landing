#!/usr/bin/env python3
"""不启动 PX4/Gazebo 的 heave touchdown 升沉触地脚本与评测纯函数测试。"""
...
from evaluate_heave_touchdown import (  # noqa: E402
...
class HeaveTouchdownTests(unittest.TestCase):
    ...
    def test_start_script_allows_all_heave_profiles_but_blocks_rollpitch(self) -> None:
        ...
        for scenario in ("heave_h1", "heave_h2", "heave_h3"):
            ...
            self.assertIn("final descent requires", allowed.stderr)
        ...
        self.assertIn("restricted to safe-altitude shadow validation", rollpitch.stderr)
